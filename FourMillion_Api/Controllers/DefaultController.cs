using Dapper;
using FourMillion_Api.DAL.Dto;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Data.SqlClient;

namespace FourMillion_Api.Controllers
{
    public class DefaultController : Controller
    {
        private readonly string _connectionString = "Server = DESKTOP-1AIF411; initial catalog = CARPLATES; integrated security = true";
